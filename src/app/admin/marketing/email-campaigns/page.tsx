...
export default function EmailCampaignsPage() {
  ...
  function loadCampaigns() { setLoading(true); globalThis.fetch('/api/admin/email-campaigns?page=' + page).then(r => r.json()).then(d => { setCampaigns(d.campaigns || []); setTotal(d.total); setTotalPages(d.totalPages) }).catch(() => toast.error('Failed')).finally(() => setLoading(false)) }
