...
function CartPanel({ cart, onUpdateQuantity, onRemove, onSetDiscount, discountSection, paymentSection, totalsDisplay, checkoutButton, heldOrders, onHoldOrder, onRecallOrder, onRemoveHeldOrder }: Props) {
  ...
  return (
    <div className="w-[380px] min-w-[380px] flex flex-col bg-[rgba(10,22,40,0.95)] rounded-xl shrink-0 self-start sticky top-0 max-h-[calc(100dvh-3rem)] border border-gold/30 shadow-[0_0_20px_-8px_rgba(212,175,55,0.3)]">
