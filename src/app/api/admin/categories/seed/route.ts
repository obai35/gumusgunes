...
const HIERARCHY = [
  ...
  },
  {
    ...
    children: [
      { name: 'Rings', slug: 'men-rings', icon: 'ring', imageUrl: '/products/cat-men-rings.jpg', description: 'Silver rings for men' },
      { name: 'Bracelets', slug: 'men-bracelets', icon: 'bracelet', imageUrl: '/products/cat-men-bracelets.jpg', description: 'Silver bracelets for men' },
