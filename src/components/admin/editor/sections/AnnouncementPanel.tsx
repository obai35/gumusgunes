  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2">
        ...
        <label className="text-xs font-medium text-muted-foreground">{ta('Show Announcement Bar')}</label>
      </div>
      <div>
        <label className="text-xs font-medium text-muted-foreground">{ta('Text (Desktop)')}</label>
      ...
      <div>
        <label className="text-xs font-medium text-muted-foreground">{ta('Text (Mobile)')}</label>
      ...
      <div className="flex items-center gap-2">
        ...
        <label className="text-xs font-medium text-muted-foreground">{ta('Dismissible')}</label>
      </div>
    </div>
  )
}
