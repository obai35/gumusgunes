...
export function SEOPanel() {
  ...
  return (
    <div className="space-y-4">
      <div>
        <label className="text-xs font-medium text-muted-foreground">{ta('Title Template')}</label>
        ...
        <p className="text-[10px] text-muted-foreground mt-0.5">{ta('Use %s as placeholder for page title')}</p>
      </div>
      <div>
        <label className="text-xs font-medium text-muted-foreground">{ta('Default Description')}</label>
      ...
      <div>
        <label className="text-xs font-medium text-muted-foreground">{ta('OG Image URL')}</label>
      ...
      <div>
        <label className="text-xs font-medium text-muted-foreground">{ta('Keywords (comma separated)')}</label>
