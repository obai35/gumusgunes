    ...
    >
      <div
        style={{
          ...
          top: '-10%',
          left: '-10%',
          background: `radial-gradient(ellipse at ${pos.x * 100}% ${pos.y * 100}%, rgba(212, 175, 55, 0.15) 0%, transparent 50%),
                       radial-gradient(ellipse at ${100 - pos.x * 100}% ${100 - pos.y * 100}%, rgba(200, 180, 140, 0.1) 0%, transparent 40%),
                       radial-gradient(ellipse at ${pos.x * 70 + 15}% ${pos.y * 70 + 15}%, rgba(212, 175, 55, 0.08) 0%, transparent 35%)`,
        }}
      />
    </div>
  )
